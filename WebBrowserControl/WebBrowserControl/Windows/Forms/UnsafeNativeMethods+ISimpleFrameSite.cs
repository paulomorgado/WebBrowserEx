...
namespace Pajocomo.Windows.Forms
{
    public static partial class UnsafeNativeMethods
    {
        ...
        public interface ISimpleFrameSite
        {
            ...
            /// <returns><see langword="true"/> if the site has processed the message and no further processing should occur; otherwise <see langword="false"/>.</returns>
            [return: MarshalAs(UnmanagedType.I4)]
            bool PreMessageFilter(
                IntPtr hwnd, [In, MarshalAs(UnmanagedType.U4)] int msg, 
                IntPtr wp, 
                IntPtr lp, 
            ...
            /// <returns><see langword="false"/> if the site processed the message; otherwise <see langword="true"/>.</returns>
            [return: MarshalAs(UnmanagedType.I4)]
            bool PostMessageFilter(
                IntPtr hwnd, 
